...
**not** implement ``CONNECT`` tunneling itself. It delegates proxying to the external
`PySocks <https://pypi.org/project/PySocks/>`_ package, which must be importable at runtime
